                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">@lang('site.providers')</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="margin-bottom: 15px">@lang('site.providers')
                                    <small> {{ $providers->total() }}</small></h3>
                                {{-- <div class="card-tools"> --}}
                                <form action="{{ route('dashboard.providers.index') }}" method="get">
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('dashboard.providers.locations.index', $provider->id) }}"
                                                            class="btn btn-md btn-info"><i
                                                                class="fa fa-eye"></i> @lang('site.show')</a>

                                                        <a href="{{ route('dashboard.providers.edit', $provider->id) }}"
                                                            class="btn btn-md btn-info"><i
                                                                class="fa fa-edit"></i> @lang('site.edit')</a>
                                                        <a href="#" class="btn delete btn-md btn-danger"><i
                                                                class="fa fa-trash"></i> @lang('site.delete')</a>
                                                        <form
                                                            action="{{ route('dashboard.providers.destroy', $provider->id) }}"
